...
menu.innerHTML = '
    ...
    <div class="macro-item" id="opt-game-list-ubg">
        <span>Games List</span>
        ${docsIcon}
    </div>
    <div class="macro-item" id="opt-youtube">
        <span>Youtube</span>
        ${youtubeIcon}
    </div>
    <div class="macro-item" id="opt-fullscreen">
...
<div class="macro-item" id="opt-copy">
    <span>Copy URL</span>
...
<div class="macro-item" id="opt-panic">
    <span>Panic Key</span>
